...
func MPDHandler(c buffalo.Context) error {
	...
	m := mpd.NewMPD(mpd.DASH_PROFILE_ONDEMAND, "PT5S", "PT1.97S")
	...
	videoRep1, err := videoAS.AddNewRepresentationVideo(1100690, "avc1.4d401e", "800k/video-1", "30000/1001", 640, 480)
	if err != nil {
		return c.Error(http.StatusInternalServerError, err)
	}
